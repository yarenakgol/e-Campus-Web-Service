...
public class UserServiceImpl implements UserService {
	...
	public UserViewDTO createUser(UserCreateDTO userCreateDTO) {
		final User user = userRepository
				.save(new User(userCreateDTO.getUserName(), userCreateDTO.getFirstName(), userCreateDTO.getLastName(),userCreateDTO.getEMail(),userCreateDTO.getPhoneNum(),userCreateDTO.getOgrNo()));
		return UserViewDTO.of(user);
	}
	...
	public UserViewDTO updateUser(Long id, UserUpdateDTO userUpdateDTO) {
		...
		user.setPhoneNo(userUpdateDTO.getPhoneNum());
		user.setOgrNo(userUpdateDTO.getOgrNo());
